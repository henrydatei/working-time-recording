...
\usepackage[acronym,indexonlyfirst,nomain,nonumberlist]{glossaries} %use 'nonumberlist' to remove page numbers from glossary
\ifdeutsch
...
\usepackage[style=authoryear,sorting=nyt,maxcitenames=2,uniquelist=false]
{biblatex}
%maxcitenames für  mehr als 2 Autoren - et al., uniquelist = false falls "Uneindeutigkeiten" laut biblatex
\begin{comment}
\usepackage[
...
\hypersetup{
    ...
    colorlinks=true,
    pdfstartview=Fit,
    pdfpagelayout=SinglePage, % zweiseitige Darstellung: ungerade Seiten rechts im PDF-Viewer - siehe auch http://tex.stackexchange.com/a/21109/9075
    filecolor=darkblue,
    urlcolor=darkblue,
    linkcolor=black,
    citecolor=black
...
\usepackage[
    title={Entwicklung eines Business-Intelligence-Systems für die Arbeitszeiterfassung im Hochschulbereich},
    author={Henry Haustein (4685025},
    type=beleg,
    institute=bir,
    course=winf,
    examiner={Prof. Dr. Benedikt Brendel},
    supervisor={Dr. Stefan Greulich},
    period={1.\ April 2023 - 30.\ September 2023}, % English: July 5, 2013;    ISO: 2013-07-05
    enddate={30.\ September 2023}, % English: January 5, 2014; ISO: 2014-01-05
    quellen={120},
    iquellen={1},
    fquellen={1968},
    lquellen={2017},
    ...
    quellenb={20},
    quellenc={70},
    quellenkw={Data Mining, Network Science, Analytics},
    quellenabb={5},
    quellentab={2},
